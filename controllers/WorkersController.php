...
//	$this->send('fox@sib12sib.ru', 'Ivan');
//	$Tmodel = BirthdayModel::getInstance();
//	$Tmodel->send('fox@sib12sib.ru', 'Ivan');
    ...
    public function actionCreate()
    {
	    ...
	    $model->img_src = UploadedFile::getInstance($model, 'img_src');
            if ($model->upload()) {
		if ($model->save(FALSE)){
...
//    protected function send($sendTo, $name){
